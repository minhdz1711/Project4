        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                    ...
                    <div class="page-header">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Danh sách loại xe</li>
                        </ol>
                    </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <button type="button" class="btn btn-success" style="width: 100px; margin: 0px 0 20px 20px;"><a style="text-decoration: none;color: white;" href="{{route('aloaixesaddnew')}}">Thêm</a></button>
                    <form>
                    ...
                    <table class="table table-bordered" id="dssp" >
                        ...
                        @foreach($loaixes as $c)
                            ...
                            <tr >
                                ...
                                <td><input type="checkbox" name="tt"   value="{{$c->trangthai}}" {{$c->trangthai==1?"checked":""}}></td>
                                
                                <td><a href="{{URL::to('/editloai').'/'.$c->id}}" class='btn btn-info'><i class="fas fa-edit"></i>Edit</a></td>
                                <td><a onclick="return confirm('Bạn có chắc muốn xóa?')" href="{{route('aloaixesremove').'/'.$c->id}}" class='btn btn-danger'><i class="fas fa-trash"></i>Delete</a></td>
                            </tr>
                            @endforeach
                            @endisset
                        </tbody>
