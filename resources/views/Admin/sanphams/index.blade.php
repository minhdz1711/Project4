            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dssp" >
                        ...
                        @foreach($sanphams as $r)
                            <tr >
                                ...
                                <td title="image"><img src="{{asset('/storage/images/products/'.$r->image)}}" style="width:80px;height:50px;text-align:center" /></td>
                    ...
                    <nav aria-label="Page navigation example" class="d-flex justify-content-center">
                        {!! $sanphams->appends(['trang'=>'Admin'])->Links() !!}    
                   </nav>
